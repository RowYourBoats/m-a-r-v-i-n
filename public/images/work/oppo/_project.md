...
personal: false
description: >-
  Designed the keynote for OPPO's Mobile World Congress keynote — a hardware launch presentation pairing motion
  graphics, bold typography, and product showcases into a single stage narrative.
credits:
  - role: Design
    name: Marvin de Jong
projects:
